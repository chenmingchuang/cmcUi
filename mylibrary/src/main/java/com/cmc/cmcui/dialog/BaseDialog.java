...
public abstract class BaseDialog implements View.OnClickListener {
    ...
    public BaseDialog(Context context, OnClickDialogListener onCallbackListener) {
        this(context, onCallbackListener, 0);
    }

    public BaseDialog(Context context, OnClickDialogListener onCallbackListener, int layoutId) {
    ...
    public Dialog initDialog(View view, Context context, int Gravity, int animId, int width, int height,
                             float dimAmount) {
        Dialog dialog = new ChenDialog(context,0);
